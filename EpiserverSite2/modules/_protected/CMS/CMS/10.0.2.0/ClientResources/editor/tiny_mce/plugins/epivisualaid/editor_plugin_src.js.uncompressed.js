(function(tinymce, $) {
    tinymce.create('tinymce.plugins.epivisualaid', {
        ...
        */
        init: function (ed, url) {
            ...
            ed.onVisualAid.add(function(ed, e, s) {
                ...
                self._injectBrowserSpecificClass(ed);
            });
        ...
        */
        ...
        _injectBrowserSpecificClass: function (ed) {
            var browserSpecificClass = "";

            if (window.tinyMCE.isAir) {
                browserSpecificClass = "epi_visualaid_air";
            }

            if (window.tinyMCE.isGecko) {
                browserSpecificClass = "epi_visualaid_gecko";
            }

            if (window.tinyMCE.isIE) {
                browserSpecificClass = "epi_visualaid_ie";
            }

            if (window.tinyMCE.isMac) {
                browserSpecificClass = "epi_visualaid_mac";
            }

            if (window.tinyMCE.isOpera) {
                browserSpecificClass = "epi_visualaid_opera";
            }

            if (window.tinyMCE.isWebKit) {
                browserSpecificClass = "epi_visualaid_webkit";
            }

            if (!browserSpecificClass) {
                return;
            }

            ed.dom.addClass(ed.getBody(), browserSpecificClass);
        }
    });
