	...
	tinymce.create('tinymce.plugins.SpellcheckerPlugin', {
		...
		_showMenu : function(ed, e) {
			...
			if (dom.hasClass(wordSpan, 'mceItemHiddenSpellWord')) {
				...
				// Setting dijitPopupParent on the the menu will make the dijit focus machinery use the
				// editor as the focus parent, rather than the menu which has body as it's parent.
				// This keeps focus in the editor preventing the blur which would stop editing and cancel
				// the spell checking.
				var editorContainer = ed.getContainer();
				var menuId = "menu_" +  m.id;
				require(["dijit/registry"], function(registry) {
					var editorWidget = registry.getEnclosingWidget(editorContainer);
					DOM.setAttrib(DOM.get(menuId), "dijitPopupParent", editorWidget.id);
				});
