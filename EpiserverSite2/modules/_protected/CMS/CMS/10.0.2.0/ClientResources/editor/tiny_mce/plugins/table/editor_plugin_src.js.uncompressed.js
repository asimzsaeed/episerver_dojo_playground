		...
		init : function(ed, url) {
				...
				mceTableMergeCells : function(grid) {
					...
					if (!ed.dom.select('td.mceSelected,th.mceSelected').length) {
						winMan.open({
							...
							width : 240 + tinymce.parseInt(ed.getLang('table.merge_cells_delta_width', 0)),
							height : 110 + tinymce.parseInt(ed.getLang('table.merge_cells_delta_height', 0)),
							inline : 1
						}, {
							rows : rowSpan,
							cols : colSpan,
			...
			each({
				mceInsertTable : function(val) {
					winMan.open({
						url : url + '/table.htm',
						width : 400 + tinymce.parseInt(ed.getLang('table.table_delta_width', 0)),
						height : 320 + tinymce.parseInt(ed.getLang('table.table_delta_height', 0)),
						inline : 1
					}, {
						plugin_url : url,
				...
				mceTableRowProps : function() {
					winMan.open({
						url : url + '/row.htm',
						width : 400 + tinymce.parseInt(ed.getLang('table.rowprops_delta_width', 0)),
						height : 295 + tinymce.parseInt(ed.getLang('table.rowprops_delta_height', 0)),
						inline : 1
					}, {
						plugin_url : url
					});
				...
				mceTableCellProps : function() {
					winMan.open({
						url : url + '/cell.htm',
						width : 400 + tinymce.parseInt(ed.getLang('table.cellprops_delta_width', 0)),
						height : 295 + tinymce.parseInt(ed.getLang('table.cellprops_delta_height', 0)),
						inline : 1
					}, {
						plugin_url : url
					});
