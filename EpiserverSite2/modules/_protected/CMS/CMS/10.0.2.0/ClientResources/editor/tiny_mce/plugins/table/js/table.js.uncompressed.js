...
function init() {
	...
	tinymce.each("cellpadding cellspacing align".split(" "), function(name) {
		var labelCell = tinyMCEPopup.dom.getParent(name + "label", "td"),
			inputCell = tinyMCEPopup.dom.getParent(name, "td");

		if (labelCell && inputCell && !tinyMCEPopup.editor.schema.isValid("table", name)) {
