...
*/
		...
		_mceInsertAnchor : function(ui, v) {
			...
			ed.windowManager.open({
				...
				width : 320 + tinymce.parseInt(ed.getLang('advanced.anchor_delta_width', 0)),
				height : 90 + tinymce.parseInt(ed.getLang('advanced.anchor_delta_height', 0)),
				inline : true
			}, {
				theme_url : this.url
			});
		...
		_mceCharMap : function() {
			...
			ed.windowManager.open({
				...
				width : 550 + tinymce.parseInt(ed.getLang('advanced.charmap_delta_width', 0)),
				height : 265 + tinymce.parseInt(ed.getLang('advanced.charmap_delta_height', 0)),
				inline : true
			}, {
				theme_url : this.url
			});
		...
		_mceColorPicker : function(u, v) {
			...
			ed.windowManager.open({
				...
				width : 375 + tinymce.parseInt(ed.getLang('advanced.colorpicker_delta_width', 0)),
				height : 250 + tinymce.parseInt(ed.getLang('advanced.colorpicker_delta_height', 0)),
		...
		_mceCodeEditor : function(ui, val) {
			...
			ed.windowManager.open({
				...
				width : tinymce.parseInt(ed.getParam("theme_advanced_source_editor_width", 720)),
				height : tinymce.parseInt(ed.getParam("theme_advanced_source_editor_height", 580)),
				inline : true,
				resizable : true,
				maximizable : true
			}, {
		...
		_mceImage : function(ui, val) {
			...
			ed.windowManager.open({
				...
				width : 355 + tinymce.parseInt(ed.getLang('advanced.image_delta_width', 0)),
				height : 275 + tinymce.parseInt(ed.getLang('advanced.image_delta_height', 0)),
				inline : true
			}, {
				theme_url : this.url
			});
		...
		_mceLink : function(ui, val) {
			...
			ed.windowManager.open({
				...
				width : 310 + tinymce.parseInt(ed.getLang('advanced.link_delta_width', 0)),
				height : 200 + tinymce.parseInt(ed.getLang('advanced.link_delta_height', 0)),
				inline : true
			}, {
				theme_url : this.url
			});
