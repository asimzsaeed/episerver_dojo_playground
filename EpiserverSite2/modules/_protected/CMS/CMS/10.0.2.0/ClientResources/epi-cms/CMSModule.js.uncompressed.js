    ...
    return declare([_Module], {
        ...
        initialize: function () {
            ...
            return when(profile.getContentLanguage()).then(lang.hitch(this, function (language) {
                ...
                this.registerDependency("epi.cms.contentRepositoryDescriptors", this._settings.contentRepositoryDescriptors);
                ...
                contextService.registerRoute("epi.cms.project", lang.hitch(this, this._redirectProjectContext));
                ...
                this._setupConverters(dependency);
        ...
        _redirectProjectContext: function (/*Object*/context, /*Object*/callerData) {
            // summary:
            //      Redirect project context
            // tags:
            //      private
            this._hashWrapper.onContextChange(context, callerData);
        },
        ...
        _setupConverters: function (dependency) {
        ...
        _initializeStores: function () {
            ...
            // Create a xform store
            registry.create("epi.cms.xform", this._getRestPath("xform"));
