...
function (
    ...
    return declare([_Command], {
        ...
        _onModelChange: function () {
            ...
            //If the model is a ContentAssetsFolder we assume that the content should be created as local asset
            this.set("createAsLocalAsset", this.model ? this.model.typeIdentifier === "episerver.core.contentassetfolder" :  false);
