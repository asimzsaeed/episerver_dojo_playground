...
function (
    ...
    return declare([ToggleCommand], {
        ...
        postscript: function () {
            ...
            when(this.store.get(this.currentContentLanguage), lang.hitch(this, function (language) {
                this.set("label", lang.replace(resources.showonlycontentin, [entities.encode(language.name)]));
            }));
        },
