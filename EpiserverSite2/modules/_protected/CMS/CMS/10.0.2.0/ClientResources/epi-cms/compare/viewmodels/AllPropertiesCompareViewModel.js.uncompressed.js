define("epi-cms/compare/viewmodels/AllPropertiesCompareViewModel", [
    ...
    return declare([Stateful, Destroyable], {
        ...
        initialize: function () {
            ...
            var updateMetadata = lang.hitch(this, function (name, oldVersion, version) {
                // If set to null or no change do an early exit
                if (!version || (oldVersion && oldVersion.contentLink === version.contentLink)) {
                    return;
                }
            ...
            updateMetadata("rightVersion", null, this.model.rightVersion);
            this.own(
                this.model.watch("rightVersion", updateMetadata),
        ...
        _addPropertyToComparison: function (comparison, property, groupName, prefix) {
            ...
            if (property.showForEdit && !epi.areEqual(leftValue, rightValue)) {
        ...
        _onPropertySaved: function (propertyName, value) {
            ...
            var group = comparison[parentMetadata.groupName.toLowerCase()],
                ...
                areEqual = epi.areEqual(value, oldValue);
