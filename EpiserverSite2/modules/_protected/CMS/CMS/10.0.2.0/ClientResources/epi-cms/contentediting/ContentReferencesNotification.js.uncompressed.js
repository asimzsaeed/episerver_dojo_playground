...
// resources
    ...
    return declare([Stateful, DestroyableByKey], {
        ...
        postscript: function () {
            ...
            this._store = this._store || dependency.resolve("epi.storeregistry").get("epi.cms.contentreferences");
        },
        ...
        _valueSetter: function (/*Object*/value) {
            ...
            when(this._store.get(value.contentData.contentLink))
                .then(this._updateNotification.bind(this));
        },

        _updateNotification: function (references) {
        ...
        _showReferenceDialog: function () {
            sharedContentDialogHandler({
                contentData: this.get("value").contentData,
                showToolbar: true,
