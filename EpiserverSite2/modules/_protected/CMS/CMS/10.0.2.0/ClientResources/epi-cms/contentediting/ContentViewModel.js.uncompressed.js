    ...
    return declare([Stateful, Destroyable], {
        ...
        _onSynchronizeFailure: function (contentLink, properties, message, results) {
            ...
            if (propertiesToRevert.length) {
                ...
                this._showErrorsDialog(res.autosave.title, res.autosave.error, errorMessages, lang.hitch(this, function () {
        ...
        _showErrorsDialog: function (title, description, errors, acknowledgeCallback) {
            // summary:
