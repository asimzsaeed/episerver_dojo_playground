...
// epi
    ...
    return declare([OverlayBasedEditorWrapper], {
        ...
        postCreate: function () {
            ...
            this.own(
                ...
                topic.subscribe("/epi/shell/action/changeview", function () {
                    // Remove the editor but don't stop the editing since that will break the
                    // content area's ability to open the create content view via the create link.
        ...
        _setupDialog: function () {
            ...
            require([this.editorWidgetType], lang.hitch(this, function (editorClass) {
