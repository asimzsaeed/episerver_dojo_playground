    ...
    return declare([DropDownMenu, _WidgetsInTemplateMixin, _ModelBindingMixin], {
        ...
        _onMainButtonClick: function () {
            if (this.mainButtonCommand) {
                ...
                var resetMainButton = lang.hitch(this, function (failure) {
                        if (failure || this.mainButtonCommand.options && this.mainButtonCommand.options.resetLabelAfterExecution) {
                            this.mainButton.set("label", this.mainButtonCommand.label);
                        }
                        domClass.remove(this.mainButton.domNode, "epi-loading");

                        if (this.mainButtonCommand.options && !this.mainButtonCommand.options.keepMenuOpen) {
                            this.onExecute();
                        }
                    }),
                    setLastExecutedCommand = lang.hitch(this, function () {
                        this.model.set("lastExecutedCommand", this.mainButtonCommand);
                    });

                when(this.mainButtonCommand.execute(), function () {
                    return when(resetMainButton(false), setLastExecutedCommand);
                }, function () {
