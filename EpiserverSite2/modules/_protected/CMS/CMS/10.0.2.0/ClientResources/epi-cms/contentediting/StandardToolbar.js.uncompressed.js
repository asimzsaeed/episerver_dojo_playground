...
], function (declare, lang, all, when, DropDownButton, ToolbarContainer, ToolbarLabel, ToolbarSet, Breadcrumb, BreadcrumbCurrentItem, ViewSelectorDropDownButton) {
    ...
    return declare([ToolbarSet], {
        ...
        setupChildren: function (/* Object[]? */ optionalToolbarGroups, /* Object[]? */ optionalToolbarItems) {
            ...
            var toolbarItems = [{
                ...
                parent: "trailing",
                name: "viewselect",
                widgetType: "epi-cms/widget/ViewSelectorDropDownButton",
                settings: {
                    showLabel: false,
                    "class": "epi-mediumButton epi-trailingContainer"
                }
            }, {
                parent: "leading",
                name: "currentcontent",
