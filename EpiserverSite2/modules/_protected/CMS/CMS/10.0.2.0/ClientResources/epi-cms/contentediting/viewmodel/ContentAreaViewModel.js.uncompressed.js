    ...
    return declare([_ContainerViewModel, _ContentContextMixin], {
        ...
        addChild: function (child /*=====, index =====*/) {
            ...
            if (!(child instanceof ContentBlockViewModel) && !(child instanceof PersonalizedGroupViewModel)) {
                ...
                this.own(model.watch("roleIdentities", lang.hitch(this, function () {
                    this.emit("changed");
                })));
                ...
                if (child instanceof PersonalizedGroupViewModel) {
                    this.own(child.on("childrenChanged", lang.hitch(this, function () {
                    ...
                    this.own(child.watch("roleIdentities", lang.hitch(this, function () {
                        this.emit("changed");
                    })));
                }
            }
            ...
            this.own(child.on("changed", lang.hitch(this, function () {
                this.emit("changed");
            })));

            this.inherited(arguments);

            this._handles[child.id] = child.on("selected", lang.hitch(this, "set", "selectedItem"));
        },
