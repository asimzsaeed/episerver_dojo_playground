...
// EPi Framework
    ...
    "epi-cms/contentediting/command/DynamicProperties",
...
// EPi CMS
    ...
    return declare([_ContentViewModelObserver, _CommandConsumerMixin, _GlobalCommandProviderMixin], {
        ...
        postscript: function () {
            ...
            this.accessRightsCommand = new AccessRightsCmd();
            this.languageSettingsCommand = new LanguageSettingsCmd();
            this.dynamicPropertiesCommand = new DynamicPropertiesCmd();
        ...
        destroy: function () {
            ...
            this.dynamicPropertiesCommand.destroy();
            this.inherited(arguments);
        },
        ...
        _setDataModelAttr: function (value) {
            ...
            this.dynamicPropertiesCommand.set("model", value);
        ...
        getCommands: function () {
            ...
            return [this.dynamicPropertiesCommand, this.languageSettingsCommand, this.expirationCommand].concat(commands);
        }
    });
});
