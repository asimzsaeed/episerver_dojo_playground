...
// EPi
    ...
    return declare([Stateful, _StatefulGetterSetterMixin], {
        ...
        _setIntermediateValueAttr: function (value) {
            ...
            this.set("enableOpenIn", value && !(value.pageShortcutType === PageShortcutTypeSupport.pageShortcutTypes.FetchData
                || value.pageShortcutType === PageShortcutTypeSupport.pageShortcutTypes.Inactive
                || value.pageShortcutType === PageShortcutTypeSupport.pageShortcutTypes.Normal));
        },

        _setSavedValueAttr: function (value) {
            // summary:
            //      Sets the saved value
            // tags:
            //      public

            this._set("savedValue", value);
