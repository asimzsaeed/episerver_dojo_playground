define("epi-cms/project/ActivityFeed", [
    "dojo/_base/declare",
    "dojo/aspect",
    "dojo/dom-class",
    "dojo/dom-geometry",
    ...
    var ActivityList = declare([OnDemandList, DijitRegistry]);
    ...
    return declare([_WidgetBase, _CssStateMixin, _FocusableMixin, _ModelBindingMixin], {
        ...
        _insertRow: function () {
            // summary:
            //      Ensures the activity is started after it has been inserted into the document.
            // tags:
            //      private
        ...
        _removeRow: function (rowElement, justCleanup) {
            // summary:
            //      Destroys the activity widget associated with the row as well as
            ...
            // This callback method runs in the context of the list.
            this.inherited(arguments);
        ...
        _setQueryAttr: function (query) {
            ...
            if (!this._queryFunction) {
                this._queryFunction = misc.debounce(this._setQueryCallback.bind(this), null, 200);
            }
        ...
        _setQueryCallback: function (store, query) {
            ...
            // number of project items selected.
