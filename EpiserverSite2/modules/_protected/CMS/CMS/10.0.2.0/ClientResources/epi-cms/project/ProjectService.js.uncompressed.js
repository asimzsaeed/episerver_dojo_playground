...
// epi
    ...
    return declare([Evented, Destroyable], {
        ...
        canAddContent: function (projectId, contentLinks) {
            ...
            return this.projectStore.executeMethod("CanAddContent", projectId, {contentReferences: uniqueContentLinks});
        },
        ...
        addProjectItems: function (projectId, contentReferences) {
            ...
            var store = this.projectItemStore,
                promises = contentReferences.map(function (reference) {
                    return store.add({ contentLink: reference, projectId: projectId });
                });

            return errorHandler.wrapXhr(all(promises));
        },
