define("epi-cms/project/command/RemoveProject", [
    ...
    return declare([_ProjectCommand], {
        ...
        _execute: function () {
            ...
            // tags:
            //      protected
            var project = this.model[this.modelPropertyToWatch];
        ...
        _createRemoveProjectConfirmationDialog: function (hasScheduledItems) {
            ...
            // tags:
            //      protected
            var isScheduled = this.model[this.modelPropertyToWatch].status === "delayedpublished",
        ...
        _removeProject: function (keepScheduling) {
            ...
            var model = this.model,
                promise = !keepScheduling && this.model.reactivateProject(model[this.modelPropertyToWatch].id);
