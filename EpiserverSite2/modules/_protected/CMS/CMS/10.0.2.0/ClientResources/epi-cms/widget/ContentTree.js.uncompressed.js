    ...
    return declare([Tree, Evented], {
        ...
        postMixInProperties: function () {
            ...
            if (this.allowManipulation) {
                ...
                this.accept = this.model.containedTypes || this.containedTypes;//We allow dropping all types contained in the content repository, even if it's not displayed in the tree.
            }
        ...
        checkItemAcceptance: function (targetNode, source, position) {
            ...
            source.forInSelectedItems(function (item) {
                // leave if we already found an item that failed
                if (!accept) {
                    return;
                }
                ...
                accept = this.model.canPaste(data, target);
            }, this);
        ...
        getTooltip: function (item) {
            ...
            return baseTooltip ? baseTooltip + ", " + headingResources.id + ": " + reference.id +
                " (" + headingResources.type + ": " + item.contentTypeName + ")" : baseTooltip;
        ...
        _onSetTargetPath: function () {
            ...
            this.model.set("handleSelection", this.handleSelection);
