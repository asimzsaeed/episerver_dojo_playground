...
//epi
    ...
    return declare([_Widget, _Container, _ModelBindingMixin], {
        ...
        _setSelectedWrapperAttr: function (target) {
            ...
            var isLanguageSelectorDisabled = true;
            if (target.settings.isContentLink) {
                isLanguageSelectorDisabled = false;
            }
            this._languageSelector.set("disabled", isLanguageSelectorDisabled);
        },
        ...
        _createInputWrappers: function () {
            ...
            when(all(createPromises), function (wrappers) {
