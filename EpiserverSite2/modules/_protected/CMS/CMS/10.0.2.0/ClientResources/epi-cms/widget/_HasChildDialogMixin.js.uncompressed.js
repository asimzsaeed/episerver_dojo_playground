define("epi-cms/widget/_HasChildDialogMixin", [
    ...
    return declare([_FocusMixin], {
        ...
        _onPopupOpen: function (openArgs) {
            // summary:
            //      Called before a popup is opened.
            //      Checks if the popup is opened for a descendant, and if so it's assumed to be a child dialog.
            var popup = openArgs.popup;

            // If the popup is a context menu with a parent node set then the dijit focus handling
            // will keep this widget in the stack and not blur the owner widget.
