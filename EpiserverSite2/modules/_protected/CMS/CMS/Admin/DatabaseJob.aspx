            ...
            <asp:DataGrid ID="logGrid" AutoGenerateColumns="False" runat="server" PageSize="10"
                ...
                <Columns>
                    <asp:TemplateColumn HeaderStyle-CssClass="epitableheading" HeaderText="<%$ Resources: EPiServer, admin.databasejob.logdate%>">
                        <ItemTemplate><%# ((DateTime)DataBinder.Eval(Container.DataItem, "ExecutedUtc")).ToLocalTime() %></ItemTemplate>
                    </asp:TemplateColumn>
                     <asp:TemplateColumn HeaderStyle-CssClass="epitableheading" HeaderText="<%$ Resources: EPiServer, admin.databasejob.logstatus%>">
                        <ItemTemplate><%# ((bool)DataBinder.Eval(Container.DataItem, "Succeeded")) ? "Succeeded" : "Failed" %></ItemTemplate>
                    </asp:TemplateColumn>
                    <asp:TemplateColumn HeaderStyle-CssClass="epitableheading" HeaderText="<%$ Resources: EPiServer, admin.databasejob.logmessage%>">
                        <ItemTemplate><%# (string)DataBinder.Eval(Container.DataItem, "Message") ?? "" %></ItemTemplate>
                    </asp:TemplateColumn>
                </Columns>
            </asp:DataGrid>
        </asp:Panel>
