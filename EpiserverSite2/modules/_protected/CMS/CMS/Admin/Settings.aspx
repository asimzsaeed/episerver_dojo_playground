    ...
    <asp:Panel runat="server" ID="tabView" CssClass="epi-padding">
        ...
        <div class="epi-formArea" ID="EditingTable" runat="server">
            <div class="epi-size25"> 
                ...
                <div class="epi-indent epi-size20">
                    <asp:CheckBox runat="server" ID="EPfEnableProjectMode"></asp:CheckBox>
                    <asp:Label runat="server" 
                        ID="EPfEnableProjectModeLabel"
                        AssociatedControlID="EPfEnableProjectMode" 
                        Translate="#enableprojectmode" />
                </div>
            </div>
        </div>
    </asp:Panel>
