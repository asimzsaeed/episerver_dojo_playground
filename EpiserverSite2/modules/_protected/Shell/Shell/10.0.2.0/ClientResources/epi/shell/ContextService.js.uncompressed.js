...
// Resources
    ...
    return declare([Destroyable], {
        ...
        constructor: function (contextStore, profile) {
        ...
        _executeInterceptors: function (context, callerData) {
            ...
            var promise = all(interceptors);

            promise.otherwise(function (error) {
                console.error("Failed to execute the context request interceptors:", error, context, callerData);
            });
        ...
        _contextLoadFailed: function (response, contextParameters, callerData) {
            ...
            // Close callback
            var onUserAction = lang.hitch(this, function (retry) {
                if (retry) {
                    // Try again
            ...
            if (contentNotFoundMessage && callerData.sender && callerData.sender.requestedContent) {
                ...
                errorDescription = lang.replace(contentNotFoundMessage,
                                                [requestedContent.typeName, requestedContent.name]);
