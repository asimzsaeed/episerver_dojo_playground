...
// dojo
    ...
    return declare([Stateful], {
        ...
        watchModelChange: function () {
            ...
            // tags:
            //      public deprecated
            kernel.deprecated("epi/shell/command/_Command","watchModelChange will be removed since it was not meant for public use", "11.0");
        ...
        unwatchModelChange: function () {
            ...
            // tags:
            //      public deprecated
            kernel.deprecated("epi/shell/command/_Command", "unwatchModelChange will be removed since it was not meant for public use", "11.0");
