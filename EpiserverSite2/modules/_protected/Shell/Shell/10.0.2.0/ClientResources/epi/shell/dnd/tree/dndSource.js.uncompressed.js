define("epi/shell/dnd/tree/dndSource", [
...
], function (array, connect, declare, domClass, domGeometry, lang, on, touch, topic, dndManager, when, dndSource, _DndDataMixin, TypeDescriptorManager) {
    return declare([dndSource, _DndDataMixin], {
        ...
        onDndDrop: function (source, nodes, copy, target) {
            ...
            if (this.containerState === "Over") {
                ...
                if (source === this) {
                    ...
                    if (model.pasteItems) {
                        model.pasteItems(items, newParentItem, copy, insertIndex);
                    } else {
            ...
            //If the nodes has been droped in another target and copy is set to false, raise the onDndItemRemoved on the source if it supports it
        ...
        _onDragMouse: function (e, firstTime) {
            ...
            // Double check for dropable ability in case checkItemAcceptance() returns deferred,
            ...
            if (this.tree && this.tree.expandOnDnd === true && this.targetAnchor) {
                this._expandOnDndTimeout = setTimeout(lang.hitch(this, function () {
