    ...
    return declare([_FormValueWidget, _WidgetsInTemplateMixin], {
        ...
        _onKeyUp: function (e) {
            ...
            switch (key) {
                ...
                case keys.HOME:
                case keys.END:
                    // Up and down will be handled by select list.
                case keys.UP_ARROW:
                case keys.DOWN_ARROW:
                    // Determine if the key pressed is a modifier key.
                case keys.CTRL:
                case keys.ALT:
                case keys.SHIFT:
                    return;
        ...
        _setQuery: function (query) {
            ...
            // Do an early exit if the query string is null or empty.
            if (!query) {
                return;
            }
            ...
            if (!this._queryFunction) {
                ...
                this._queryFunction = misc.debounce(queryCallback.bind(this), null, 200);
            }

            // Set the query.
            this._queryFunction({ query: query });
        },
