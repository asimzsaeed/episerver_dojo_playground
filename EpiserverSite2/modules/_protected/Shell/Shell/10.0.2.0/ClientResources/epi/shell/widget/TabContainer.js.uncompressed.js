...
// resources
    ...
    return declare([TabContainer, _ActionConsumerWidget], {
        ...
        _createTab: function () {
            ...
            var parentContainer = this._componentsController.getComponentDefinition(this.id);
        ...
        _changeName: function (/*dijit/_Widget*/page, /*String*/value) {
            ...
            if (this._isEmpty(value)) {
                this._showMessageDialog(this.res.tabnamecannotbeemptymessage).then(function (canExecute) {
                    if (canExecute) {
                ...
                if (item) {
                    ...
                    this._componentsController.saveComponents(
                        ...
                        lang.hitch(this, function () { // onErrorCallback
                            this._showMessageDialog(this.res.tabnamecouldnotbesaved).then(function (canExecute) {
                                if (canExecute) {
        ...
        closeChild: function (/*dijit/_Widget*/page) {
            ...
            if (!this.confirmationBeforeRemoval) {
                ...
                return this._showRemovalConfirmationDialog(lang.hitch(this, function (close) {
                    if (close) {
        ...
        _showRemovalConfirmationDialog: function (/*Function*/fnRemoveCallback) {
            // summary:
