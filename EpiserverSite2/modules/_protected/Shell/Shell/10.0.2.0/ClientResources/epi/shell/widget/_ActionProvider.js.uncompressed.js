...
function (dojo, array, kernel, _ActionProviderBase) {
    ...
    return dojo.declare([_ActionProviderBase], {
        ...
        constructor: function () {
            kernel.deprecated("epi/shell/widget/_ActionProvider", "use the command pattern with epi/shell/command/_CommandProviderMixin instead");
