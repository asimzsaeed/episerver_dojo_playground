define("epi/shell/widget/dialog/ErrorDialog", [
    ...
    //TODO: Use dojo.declare instead
    return function () {
        /// <summary>
        /// "Singleton" implementation of an error message dialog where require handles
        /// the singleton behaviour by only loading this file once.
        /// </summary>
    ...
    ";
        ...
        var pub = {
            ...
            showXmlHttpError: function (response, ioArgs) {
                ...
                /// </summary>
                /// <param name="message">The message returned as parameter to an dojo.xhr error callback</param>
                /// <param name="ioArgs">The ioArgs parameter for the dojo.xhr error callback</param>
