...
], function (epi, dojo, array, domClass, domStyle, query, template, when, a11y, focus, Dialog, _DialogMixin, _FocusableMixin) {

    return dojo.declare([Dialog, _DialogMixin, _FocusableMixin], {
        // summary:
